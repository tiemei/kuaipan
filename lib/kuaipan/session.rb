module Kuaipan
  class Session
    ...
    def_delegators :base, :account_info, :upload_file, :create_folder, :delete, :metadata, :copy, :download_file, :thumbnail, :shares, :move
    def_delegators :authorize_url, :[]
    
    def initialize(opt={})
      oauth_callback = opt.delete :oauth_callback
      @consumer = KAuth::Consumer.new Config[:oauth_consumer_key], Config[:oauth_consumer_secret], Config.options_base
      # get rtoken
